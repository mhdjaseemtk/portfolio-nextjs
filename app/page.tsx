...
export default function Home() {
  return (
    <>
      <main
        className="jaseem overflow-x-hidden overflow-y-clip bg-black relative selection:bg-amber-500 selection:text-white font-inter w-full max-w-[100vw]"
      >
      ...
      ======================== */}
        <nav className="relative z-50 flex justify-between items-center px-6 py-8 md:px-16 max-w-[1920px] mx-auto">
          ...
          <div className="hidden lg:flex gap-10 mr-30 text-[14px] font-bold tracking-[0.2em] text-gray-400 uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12  gap-4">
            ...
            <div className="md:col-span-8 mt-32 md:mt-60 flex m-5 flex-col justify-center items-start">
              <h1 className="font-oswald gap-3 font-bold leading-[0.8] tracking-tighter uppercase text-white flex flex-col items-start w-full break-words">
                ...
                <span className="text-5xl sm:text-9xl md:text-[120px] lg:text-[150px]">Deliver</span>
              </h1>

              <div className="mt-8 md:mt-16 flex flex-col md:flex-row gap-8 items-start md:items-center">
