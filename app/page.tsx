    ...
    <>
      ...
      >
        ...
        <motion.nav
          ...
          className={`fixed top-0 w-full z-[60] flex justify-between items-center px-6 md:px-16 transition-all duration-300 ${scrolled ? "py-4 bg-gery-500 backdrop-blur-md border-b border-white/10" : "py-8 bg-transparent"
            }`}
        >
          <button
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="fixed inset-0 z-50  backdrop-blur-xl flex flex-col items-center justify-center gap-8"
            >
              {navLinks.map((link, i) => (
                <motion.button
                  key={link.id}
        ...
        {/* MAIN HERO CONTENT */}
        <div className="relative z-30 w-full max-w-[1920px] mx-auto overflow-hidden px-4 md:px-16 flex flex-col justify-center box-border pt-24">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
