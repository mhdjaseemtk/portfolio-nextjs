          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            >
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 border border-neutral-700 text-gray-300 px-8 py-4 rounded-lg font-bold text-sm tracking-wide uppercase transition-all duration-300 hover:border-amber-500/50 hover:text-white hover:bg-white/[0.03]"
              >
                <Eye
                  size={18}
